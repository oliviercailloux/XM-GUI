...
public class AlternativesRankingMarshaller {
	...
	/**
	 * This method marshalls AlternativesRanking objects to output an XML file
	...
	/**
	 * This method outputs AlternativesRanking's values in a Node format to be used
	 * in Diviz's web services call through the CallAltsRank class.
	 * 
	 * @param altr the AlternativesRanking from which the alternatives and values
	 *             are extracted
	...
	public Element altsRankingNodeForWSCall(AlternativesRankingMarshaller altr, Document doc) {
		...
		ImmutableSetMultimap<Integer, Alternative> map = AltR.getAltSet(); // AltR shouldn't be called from the class
