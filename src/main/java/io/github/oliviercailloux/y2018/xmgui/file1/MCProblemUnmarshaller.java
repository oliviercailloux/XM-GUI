...
public class MCProblemUnmarshaller {
	...
	/**
	 * This method reads a multi-criteria problem in the form of an XML file abiding
	 * by the XMCDA standard.
	 * 
	 * @param in the InputStream corresponding to the XML file containing the
	...
	/*
	 * This method finds and reads the X2Alternatives item from an unmarshalled XML
	...
	/*
	 * This method extracts the ID of a specific X2Alternative from a list of
	 * X2Alternatives and create a corresponding Alternative object.
	 * 
	...
	/*
	 * This method extracts the ID of a specific X2Criterion from a list of
	 * X2Criteria and create a corresponding Criterion object.
	 * 
	...
	/*
	 * This method finds and reads the X2PerformanceTable item from an unmarshalled
	 * XML file abiding by the XMCDA standard.
	 * 
	 * @param xmcdaSubElements the unmarshalled project references of the XMCDA file
	 * 
	...
	/*
	 * This method extracts the values of a specific X2Alternative's performance on
	 * every X2Criterion and put every performance value in a MCProblem object,
	 * using Alternative's and Criterion's unique ID.
	 * 
	 * @param i the index of the specific X2Alternative in the list, from which
	 * performance values will be extracted
	 * 
	 * @param altsOnCriteriaPerfs is the list of X2Alternative objects evaluated on
	 * all criteria
	 */
	public void getListOfX2AlternativePerformancesOnCriteriaAndPutInMcp(int i,
			List<X2AlternativeOnCriteriaPerformances> altsOnCriteriaPerfs) {
