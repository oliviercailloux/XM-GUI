...
public class AlternativesRankingUnmarshaller {
	...
	/**
	 * This method reads a ranking of alternatives in the form of an XML file
	...
	/**
	 * This method finds and reads the X2AlternativeValue item from an unmarshalled
	...
	/**
	 * This method extracts the ID of the Alternative from a list of
	 * X2AlternativeValue and create a corresponding Alternative object.
	 * 
